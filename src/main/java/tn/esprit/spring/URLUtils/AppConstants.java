package tn.esprit.spring.URLUtils;

public class AppConstants {
	public static final String EMPLOYEE_URI = "/image";
	public static final String EMPLOYEE_JSON_PARAM ="imgJson";
	public static final String EMPLOYEE_FILE_PARAM ="file";
	public static final String SUCCESS_CODE = "IMG-200";
	public static final String SUCCESS_MSG = "Image created successfully";
	...
	public static final String TEMP_DIR = "C://xampp//";
